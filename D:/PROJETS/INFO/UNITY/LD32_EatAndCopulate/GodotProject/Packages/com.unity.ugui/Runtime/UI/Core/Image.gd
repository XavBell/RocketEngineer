...
export var m_Sprite: AtlasTexture
export var m_PreserveAspect: bool
export var m_FillCenter: bool
export var m_FillAmount: float
export var m_FillClockwise: bool
export var m_FillOrigin: int
export var m_UseSpriteMesh: bool
export var m_PixelsPerUnitMultiplier: float
export var m_Material: Resource
