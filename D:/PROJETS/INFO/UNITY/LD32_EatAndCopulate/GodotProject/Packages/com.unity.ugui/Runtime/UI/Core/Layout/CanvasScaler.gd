...
export var m_ReferencePixelsPerUnit: float
export var m_ScaleFactor: float
export var m_ReferenceResolution: Vector2
export var m_MatchWidthOrHeight: float
export var m_FallbackScreenDPI: float
export var m_DefaultSpriteDPI: float
export var m_DynamicPixelsPerUnit: float
export var m_PresetInfoIsWorld: bool
