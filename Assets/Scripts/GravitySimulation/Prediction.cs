...
public class Prediction : MonoBehaviour
{
    ...
    public static UnityEngine.Vector3 GetOrbitPositionKepler(float gravityParam, float time, float semiMajorAxis, float eccentricity, float argPeriapsis, float LAN, float inclination, float trueAnomalyAtEpoch)
    {
